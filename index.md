...
venue: "DNB + ZB MED - Library Carpentry Workshop"        # brief name of the institution that hosts the workshop without address (e.g., "Euphoric State University")
...
humandate: "Oct 27 - Oct 28, 2025"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
instructor: ["Rabea Müller", "TBA"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
...
collaborative_notes: https://pad.gwdg.de/0VrwD81MTTq4d3bFJ2PEGg # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document (e.g., https://pad.carpentries.org/2015-01-01-euphoria)
